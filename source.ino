...
void checkMedSchedule(void)
{
  if(pill1.isActive())
  {
    ...
    Serial.print("It is time to take Statins now: ");
  ...
  if(pill2.isActive())
  {
    ...
    display.println("");
    display.display(); 
    Serial.print("It is time to take Biogesic now: ");
  ...
  if(pill3.isActive())
  {
    ...
    display.println("");
    display.display(); 
    Serial.print("It is time to take Advil now: ");
